...
(function (global) {
  ...
  var MEMBER_CONFIG = {
    ...
    qaList: [
      ...
      { q: '每次可以退几台车？',        a: '<p>每次申请仅限 <strong>1 台车</strong>，且限<strong>非报废车辆</strong>使用。</p>' },
      { q: '无理由退车本月已用过 1 次，还能再用吗？', a: '<p><strong>本月不能了，下月 1 日自动恢复。</strong>无理由退车<strong>每个自然月限用 1 台</strong>，用满即止；每月 1 日随会员等级一同重置，新月可再用 1 台。</p><p>请注意区分两个时限：「中标后 24 小时内可申请」是针对<strong>每一台车</strong>的申请时效；「每月 1 台」是<strong>当月总量上限</strong>——即使本月中标多台车、每台都在 24 小时内，也只能选其中 1 台使用该权益。</p>' },
