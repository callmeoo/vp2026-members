...
(function (global) {
  ...
  var MEMBER_CONFIG = {
    ...
    qaList: [
      ...
      { q: '会员等级变化规则',   a: '<p>每月 1 日，系统将根据用户上一周期(本月前最近的 3 个自然月，不含本月)的累计成交台数进行定级。</p><p>达标则等级将更新。您可在会员等级页面查看最新的等级和对应的权益。</p><p><strong>注意：</strong>本月中，若您最近 3 个自然月(含本月)累计成交台数达到更高等级的门槛，将进行实时升级。但如月底时台数不足，则可能在下月 1 日降回对应等级。</p>' },
