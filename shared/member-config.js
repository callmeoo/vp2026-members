...
(function (global) {
  ...
  var MEMBER_CONFIG = {
    ...
    recommendedTasks: [
      { id: 't_deal',     action: '车辆成交',                       points: 50, unit: '',    desc: '非报废车完成过户后发放，售后退车将扣回', highlight: true },
    ...
    // ─────────────────────────────────────────────
    qaList: [
      { q: '会员等级如何评定？',        a: '<p>唯普会员等级<strong>每月 1 日统一评定</strong>，由商户近 3 个自然月的累计成交台数和账户总金额共同决定。</p><p>定级后，当月等级保持不变；本月新增成交或账户总金额变化，将在<strong>下月 1 日</strong>定级时生效。</p>' },
      { q: '什么是成交台数？',          a: '<p>成交台数是用户最近 3 个自然月(含本月)在唯普平台<strong>已付款</strong>的车辆数量(不含退车)。</p><p>特别提示：退车将冲减对应的成交台数。</p>' },
      { q: '会员等级有效期多久？',      a: '<p>会员等级<strong>每月 1 日</strong>更新一次，更新后的等级有效期为<strong>当月 1 日至当月最后一日</strong>。</p>' },
      { q: '如何提升会员等级？',        a: '<p>您可以通过增加成交台数、保持账户总金额满足定级要求来提升会员等级。</p><p>本月新增成交将在<strong>下月 1 日</strong>定级时生效。</p>' },
      { q: '什么是 24 小时退车权益？',   a: '<p>钻石会员中标<strong>非报废车辆</strong>后，可在<strong>中标后 24 小时内</strong>申请退车。</p><p>申请通过后，由平台承担本次退车产生的退车违约金，用户无需承担该笔违约金。</p>' },
      { q: '如何申请 24 小时退车权益？', a: '<p>车辆中标后，如订单处于待支付状态，可进入【订单】-【待支付】-【订单详情页】，点击【申请售后】，在权益抵扣模块选择使用「无理由退车」权益，并按页面提示提交申请。</p><p>如订单已支付，且距离车辆中标不足 24 小时，可联系客服帮忙处理。</p>' },
      { q: '每次可以退几台车？用过 1 次后还能再用吗？', a: '<p>每次申请仅限 <strong>1 台车</strong>，且限<strong>非报废车辆</strong>使用；该权益<strong>每个自然月限用 1 台</strong>，本月用满即止、当月不能再用。</p><p>到下月 1 日会员等级重新评定时，<strong>若仍为钻石会员</strong>，额度刷新、可再用 1 台；<strong>若已降级则不再享有此权益</strong>。</p><p>请注意区分两个时限：「中标后 24 小时内可申请」是针对<strong>每一台车</strong>的申请时效；「每月 1 台」是<strong>当月总量上限</strong>——即使本月中标多台车、每台都在 24 小时内，也只能选其中 1 台使用该权益。</p>' },
      { q: '退车后积分和款项怎么处理？', a: '<p>退车成功后，<strong>已发放的车辆成交积分将扣减</strong>；涉及已支付款项的，按平台退款流程处理。</p>' },
